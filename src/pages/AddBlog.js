...
import { createBlog, getABlog, resetState } from '../features/blogs/blogsSlice';
...
const AddBlog = () => {
  ...
  const { isError, isLoading, isSuccess, createBlogs, blogTitle, blogDescription,blogCategory, blogImages  } = newBlogs;
